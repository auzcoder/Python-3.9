...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/www/server/python_manager/versions/3.9.10/bin',
 'BINLIBDEST': '/www/server/python_manager/versions/3.9.10/lib/python3.9',
 ...
 'CONFIG_ARGS': "'--prefix=/www/server/python_manager/versions/3.9.10'",
 'CONFINCLUDEDIR': '/www/server/python_manager/versions/3.9.10/include',
 'CONFINCLUDEPY': '/www/server/python_manager/versions/3.9.10/include/python3.9',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/tmp/Python-3.9.10/coverage.info',
 'COVERAGE_REPORT': '/tmp/Python-3.9.10/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include',
 'CXX': 'g++',
 'DESTDIRS': '/www/server/python_manager/versions/3.9.10 '
             '/www/server/python_manager/versions/3.9.10/lib '
             '/www/server/python_manager/versions/3.9.10/lib/python3.9 '
             '/www/server/python_manager/versions/3.9.10/lib/python3.9/lib-dynload',
 'DESTLIB': '/www/server/python_manager/versions/3.9.10/lib/python3.9',
 'DESTPATH': '',
 'DESTSHARED': '/www/server/python_manager/versions/3.9.10/lib/python3.9/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/www/server/python_manager/versions/3.9.10/include '
                   '/www/server/python_manager/versions/3.9.10/include '
                   '/www/server/python_manager/versions/3.9.10/include/python3.9 '
                   '/www/server/python_manager/versions/3.9.10/include/python3.9',
 'INCLUDEDIR': '/www/server/python_manager/versions/3.9.10/include',
 'INCLUDEPY': '/www/server/python_manager/versions/3.9.10/include/python3.9',
 ...
 'LDVERSION': '3.9',
 'LIBC': '',
 'LIBDEST': '/www/server/python_manager/versions/3.9.10/lib/python3.9',
 'LIBDIR': '/www/server/python_manager/versions/3.9.10/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/www/server/python_manager/versions/3.9.10/lib/pkgconfig',
 'LIBPL': '/www/server/python_manager/versions/3.9.10/lib/python3.9/config-3.9-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/www/server/python_manager/versions/3.9.10/lib/python3.9',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 1,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/www/server/python_manager/versions/3.9.10/share/man',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/www/server/python_manager/versions/3.9.10/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'abs_builddir': '/tmp/Python-3.9.10',
 'abs_srcdir': '/tmp/Python-3.9.10',
 'datarootdir': '/www/server/python_manager/versions/3.9.10/share',
 'exec_prefix': '/www/server/python_manager/versions/3.9.10',
 'prefix': '/www/server/python_manager/versions/3.9.10',
 'srcdir': '.'}
